package androidcustomcalendar.adms.com.calender.ui.fragment.setting.birth;
...
public class AddFragment extends BaseFragment implements AdapterView.OnItemSelectedListener, CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    private static final NumberPicker.Formatter NORMAL_MONTH_FORMATTER = value -> String.format(Locale.ENGLISH, "Bulan %d", value);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        if (isChecked) {
            isLunar = "Kalender bulan".equals(buttonView.getText());
