...
public class PermissionUtils {
    ...
    public static void manual(Activity activity) {
        new AlertDialog.Builder(activity)
                .setMessage("Anda menolak untuk memberikan izin, fitur ini tidak akan berfungsi dengan baik ...")
                .setPositiveButton("Otorisasi manual", (dialog, which) -> {
                    toSettings(activity);
                })
                .setNegativeButton("Jangan gunakan fitur ini", null)
                .show();
    }
