package androidcustomcalendar.adms.com.calender.ui.fragment.setting.theme;
...
import androidcustomcalendar.adms.com.calender.ui.activity.LaunchActivity;
...
public class ThemeFragment extends BaseFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public static class ThemeHandler extends Handler{
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case WAIT:
                    fragment.mProgressDialog = ProgressDialog.show(fragment.mHostActivity, null, "Mohon tunggu sebentar...", true);
                    break;
                case CANCEL:
