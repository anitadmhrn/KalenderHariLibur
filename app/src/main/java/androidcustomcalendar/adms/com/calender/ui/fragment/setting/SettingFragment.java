package androidcustomcalendar.adms.com.calender.ui.fragment.setting;
...
import androidcustomcalendar.adms.com.calender.ui.activity.ZoomActivity;
...
import androidcustomcalendar.adms.com.calender.ui.fragment.setting.birth.BirthFragment;
import androidcustomcalendar.adms.com.calender.ui.fragment.setting.symbol.SymbolFragment;
import androidcustomcalendar.adms.com.calender.ui.fragment.setting.theme.ThemeFragment;
import androidcustomcalendar.adms.com.calender.ui.fragment.setting.widget.PicSetFragment;
import androidcustomcalendar.adms.com.calender.ui.fragment.setting.widget.TransparentWidgetFragment;
import androidcustomcalendar.adms.com.calender.ui.widget.WidgetManager;
...
public class SettingFragment extends BaseFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, GlobalData.LoadCallBack {
    ...
    public void onSuccess() {
        showSnackbar("Sinkronisasi yang berhasil！");
    ...
    public void onFail(String error) {
        showSnackbar("Sinkronisasi gagal, silakan hubungi pengembang! "," Salin pesan kesalahan ", v -> {
            ...
            Toast.makeText(mHostActivity, "Informasi telah disalin", Toast.LENGTH_SHORT).show();
        });
        mHandler.sendEmptyMessage(CANCEL);
    }
            ...
            try {
                switch (msg.what) {
                    case UPDATE:
                        ...
                        break;
                    case WAIT:
                        mProgressDialog = ProgressDialog.show(fragment.getContext(), null, "Mohon tunggu sebentar...");
                        break;
                    case CANCEL:
