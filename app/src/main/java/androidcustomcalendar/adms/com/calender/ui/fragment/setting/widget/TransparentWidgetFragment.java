package androidcustomcalendar.adms.com.calender.ui.fragment.setting.widget;
...
import androidcustomcalendar.adms.com.calender.ui.adapter.month.MonthDayAdapter;
import androidcustomcalendar.adms.com.calender.ui.floatwindow.FloatWindowService;
...
public class TransparentWidgetFragment extends BaseFragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE_SYSTEM_ALERT_WINDOW) {
            new AlertDialog.Builder(mHostActivity)
                    .setMessage("Tolong beri izin float window")
                    .setPositiveButton("Pengaturan", (dialog, which) -> PermissionUtils.toSettings(mHostActivity))
                    .show();
        } else {
    ...
    private void setWidgetView() {
        ...
        ((TextView) findViewById(R.id.tv_date)).setText(String.format(Locale.CHINA, "%02d", month));
