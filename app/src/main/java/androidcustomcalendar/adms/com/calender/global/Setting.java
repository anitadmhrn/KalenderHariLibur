...
public final class Setting {
    ...
    public static void loadSetting(Context context) {
        ...
        putEventType(setting, Symbol.STAR.KEY, "default");
        putEventType(setting, Symbol.RECT.KEY, "default");
        putEventType(setting, Symbol.CIRCLE.KEY, "default");
        putEventType(setting, Symbol.TRIANGLE.KEY, "default");
        putEventType(setting, Symbol.HEART.KEY, "default");
