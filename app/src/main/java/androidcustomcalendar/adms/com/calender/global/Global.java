package androidcustomcalendar.adms.com.calender.global;


public class Global {
    public static final int YEAR_START = 1900; //awal tahun
    public static final int YEAR_START_REAL = 1910; //Tahun terkecil ditampilkan di kalender
    ...
    public static final String SETTING_TRANS_WIDGET_ALPHA = SETTING_WIDGET_ALPHA; //Untuk menjaga kompatibilitas dengan versi sebelumnya
    ...
    public static final int VIEW_WEEK = 0; //Tampilkan minggu
    public static final int VIEW_DAY = 1; //hari
