package androidcustomcalendar.adms.com.calender.ui.fragment.event;
...
import androidcustomcalendar.adms.com.calender.entity.Symbol;
...
public class EditEventFragment extends BaseFragment
    ...
    protected void setupUI() {
        ...
        if (mEvent != null) {
            ...
            String date = String.format(Locale.CHINA, "%s" +"-"+ "%d"+"-"+"%d",
    ...
    private void paste() {
        ...
        if (primaryClip.getItemCount() > 0) {
            new AlertDialog.Builder(mHostActivity).setTitle("Konten papan klip")
                    .setMessage(message)
                    .setPositiveButton("Tempel", (dialog, which) -> {
                        mEditText.append(message);
                        dialog.dismiss();
                    })
                    .setNegativeButton("Batalkan", (dialog, which) -> dialog.dismiss()).show();
        } else {
            new AlertDialog.Builder(mHostActivity).setMessage("Tidak ada di clipboard >_<").show();
        }
    }
    ...
    public void onValueChange(int year, int month, int day) {
        String date = String.format(Locale.CHINA, "%s" +"-"+ "%d"+"-"+"%d", String.valueOf(year), month, day);
        mBtnDate.setText(date.substring(2));
    }
